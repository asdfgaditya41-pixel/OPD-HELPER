                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          const SizedBox(width: 48), // Placeholder to center logo if needed
                          Expanded(
                            child: Center(
                              child: Container(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(Icons.translate, size: 16, color: Colors.white.withOpacity(0.7)),
                                  const SizedBox(width: 8),
                                  Text(
                                    langService.isHindi ? 'English' : 'हिंदी',
                      ...
                      Text(
                        AppTranslations.getText('select_portal', locale),
                        style: TextStyle(
                      ...
                      _BouncingRoleCard(
                        ...
                        title: AppTranslations.getText('i_am_civilian', locale),
                        subtitle: AppTranslations.getText('civilian_subtitle', locale),
                      ...
                      _BouncingRoleCard(
                        ...
                        title: AppTranslations.getText('i_am_hospital', locale),
                        subtitle: AppTranslations.getText('hospital_subtitle', locale),
                        gradient: const LinearGradient(
